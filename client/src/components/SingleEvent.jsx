...
export default class SingleEvent extends Component {
	...
	getSingleEventData = () => {
		axios.get(`/api/users/${this.state.userId}/events/${this.state.eventId}`).then((res) => {
					...
					<form onSubmit={this.updateEvent} className="col s12">
						<div className="col">
							<div className="col s12 m6 text-center">
								<label style={{ marginRight: '30px', marginTop: '30px' }} htmlFor="eventName">
									Event Name
								</label>
								<input
							...
							<div className="col s12 m6 text-center">
								<label style={{ marginRight: '30px', marginTop: '40px' }} htmlFor="time">
									Time
								</label>
								<input
