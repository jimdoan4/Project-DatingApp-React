                ...
                <h3 style= {{ marginTop: '30px' }} className="text-center">{this.state.event.eventName}</h3>
                {
                    ...
                    : <div>
                        <div className="text-center">
                            ...
                            <button style= {{ marginTop: '20px', width: '12rem', marginBottom: '30px', backgroundColor: 'white', borderColor: 'white',color: 'black', borderColor: 'black'}} onClick = {this.deleteEvent}>Delete Event</button>
                        </div>
                     </div>
                }
